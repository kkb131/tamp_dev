...
# Import protocol — works whether run from project root or copied standalone
try:
    ...
    # Operator PC: teleop_protocol.py copied into vive/ directory
    from vive.teleop_protocol import (  # type: ignore[no-redef]
        ButtonState,
        TeleopPosePacket,
        make_query_pose_bytes,
        parse_pose_response,
