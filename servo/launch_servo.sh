...
show_info() {
    ...
    echo "    ros2 launch ur_robot_driver ur10e.launch.py use_mock_hardware:=true robot_ip:=0.0.0.0"
    echo ""
    ...
    echo "    cd ${WS_DIR}/src/tamp_dev && python3 servo/keyboard_forward.py"
    echo ""
