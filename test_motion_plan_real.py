...
SAFE_TARGETS = {
    'verify_home': [2.24,  -1.2808, 2.16,  -0.8848, 2.24,  0.0],   # home 기준점
    'micro_wrist': [2.24,  -1.2808, 2.16,  -1.0348, 2.24,  0.0],   # wrist_1: -8.6° (−0.15 rad)
    'micro_pan':   [2.34,  -1.2808, 2.16,  -0.8848, 2.24,  0.0],   # shoulder_pan: +5.7° (+0.1 rad)
    'safe_return': [2.24,  -1.2808, 2.16,  -0.8848, 2.24,  0.0],   # home 복귀
}

# 전체 테스트용 타겟 (--stage full에서 사용)
FULL_TARGETS = {
    'home':               [2.24,  -1.2808, 2.16,  -0.8848,  2.24,   0.0],
    'up':                 [2.24,  -1.2808, 2.16,   -1.26,    2.24,   0.0],
