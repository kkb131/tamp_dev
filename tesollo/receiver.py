...
from manus.manus_reader import HandData, NUM_JOINTS, NUM_FINGERS
from tesollo.retarget import ManusToD5FRetarget
from tesollo.tesollo_config import TesolloConfig
...
def main():
    ...
    client = None
    if not args.dry_run:
        from tesollo.dg5f_client import DG5FClient
        client = DG5FClient(
            ip=cfg.hand.ip,
            port=cfg.hand.port,
            hand_side=cfg.hand.side,
