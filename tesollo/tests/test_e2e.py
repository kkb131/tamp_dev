...
from tesollo.receiver import ManusReceiver
from tesollo.retarget import ManusToD5FRetarget, RIGHT_LIMITS
...
def main():
    ...
    from tesollo.dg5f_client import RIGHT_JOINT_NAMES
