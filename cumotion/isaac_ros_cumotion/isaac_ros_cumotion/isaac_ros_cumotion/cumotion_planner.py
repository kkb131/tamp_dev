...
class CumotionActionServer(Node):
    ...
    def execute_callback(self, goal_handle):
        ...
        # NOTE: goal_handle.succeed() must be called AFTER result is ready (not here).
        # Calling it early with no result causes MoveIt to receive an empty trajectory.
        ...
        if result.error_code.val == MoveItErrorCodes.SUCCESS:
            # Pass result directly so rclpy sends trajectory via the future immediately.
